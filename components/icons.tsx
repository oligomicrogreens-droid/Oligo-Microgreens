...
export const CogIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.003 1.11-1.226l.043-.018c.22-.1.454-.146.69-.163m.69.163c.236.017.47.063.69.163l.043.018c.55.223 1.02.684 1.11 1.226m-2.096 0c.092.542.56 1.003 1.11 1.226l.043.018c.22.1.454.146.69.163m-1.536 0c-.092-.542-.56-1.003-1.11-1.226L12 2.72l-.043.018c-.22.1-.454.146-.69.163m0 0c-.236-.017-.47-.063-.69-.163l-.043-.018c-.55-.223-1.02-.684-1.11-1.226m2.096 0c-.092.542-.56-1.003-1.11-1.226l-.043.018c-.22.1-.454.146-.69.163m-1.536 0c.092-.542.56-1.003-1.11-1.226l.043.018c.22-.1.454-.146.69.163m1.536 0c.092.542.56 1.003 1.11 1.226l.043.018c.22.1.454.146.69.163m-2.828 0c-.22.1-.454.146-.69.163m2.828 0c.22-.1.454-.146.69-.163m-2.828 0c.092.542.56 1.003 1.11 1.226l.043.018c.22.1.454.146.69.163m-1.536 0c-.092-.542-.56-1.003-1.11-1.226L12 2.72l-.043.018c-.22.1-.454.146-.69.163m0 0c-.236-.017-.47-.063-.69-.163l-.043-.018c-.55-.223-1.02-.684-1.11-1.226m2.096 0c.092.542.56 1.003 1.11 1.226l.043.018c.22.1.454.146.69.163m-1.536 0c-.092-.542-.56-1.003-1.11-1.226L12 2.72l-.043.018c-.22.1-.454.146-.69.163m0 0c-.236-.017-.47-.063-.69-.163l-.043-.018c-.55-.223-1.02-.684-1.11-1.226M12 18a6 6 0 100-12 6 6 0 000 12z" />
    </svg>
);
...
export const ArrowsUpDownIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const ScaleIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0012 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52l2.62 10.726c.122.499-.106 1.028-.589 1.202a5.988 5.988 0 01-2.036.243c-2.132 0-4.14-.356-6.032-.998a5.988 5.988 0 01-2.036-.243c-.483-.174-.711-.703-.59-1.202L9 5.491m-3-.521c-.99.203-1.99.377-3 .52M3 5.491l2.62 10.726c.122.499.106 1.028.589 1.202a5.988 5.988 0 002.036.243c2.132 0 4.14-.356 6.032-.998a5.988 5.988 0 002.036.243c.483-.174.711-.703.59-1.202L15 5.491m-6 0a51.317 51.317 0 01-2.62 10.726" />
    </svg>
);

export const ReorderIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const LightBulbIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a3 3 0 00-3-3m3 3a3 3 0 003-3m-3 3V11.25m2.25 2.25a.75.75 0 000-1.5m-4.5 0a.75.75 0 000 1.5M12 11.25a2.25 2.25 0 00-2.25 2.25v.75m2.25-3a2.25 2.25 0 012.25 2.25v.75M3 18.75a9 9 0 0118 0v-1.125a9 9 0 00-18 0v1.125z" />
    </svg>
);

export const SeedIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.343A5.996 5.996 0 0 1 18.343 12c0 3.314-2.686 9-6.343 9S6 15.314 6 12A5.996 5.996 0 0 1 12 6.343z" />
    </svg>
);

export const BanknotesIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414-.336.75-.75.75h-.75m0-1.5h.375c.621 0 1.125.504 1.125 1.125v.375m-18 0h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v.75A2.25 2.25 0 004.5 9.75h15M8.25 12h.008v.008H8.25V12zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm4.125 4.5h.008v.008h-.008V16.5zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
    </svg>
);